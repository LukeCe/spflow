...
# simulated flows from the stylized states of Germany to those of the USA.
...
target_matrices <- list(
  ...
  "DW" = DW,
  "P_"  = list(
    "DISTANCE" = dense_matrix_form(ge_usa_vec_data[,"P_DISTANCE"])),
  "Y1_" = list(
...
expected_trend <- W_d %*% ge_usa_vec_data[,"y2"] * rd
...
expected_trend <- expected_trend <- WF9 %*% ge_usa_vec_data[,"y9"]
