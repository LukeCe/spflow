...
#' @param lonlat1 A data.frame or matrix with longitude and latitude in columns
#' @param lonlat2 A data.frame or matrix with longitude and latitude in columns
#' @return A vector of great circle distances in km
#' @example
#' pairs_berlin <- data.frame(lon = c(2.349014,13.404954), lat = c(48.864716, 52.520008))
#' haversine_distance(pairs_berlin,pairs_berlin[2:1, ])
#'
#' @export
